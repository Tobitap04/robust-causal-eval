...
def causal_chain_filter(question: str, answer: str) -> str:
    ...
    instruction = (
        ...
        "Instructions:\n"
        "Step 0: If the question follows the structure “(Can / Could / Does / Might) A (cause / lead to / result in / "
        "affect) B?”"
        ...
        "Step 2: Attempt to construct a causal chain between the identified cause and effect in the form: Cause → … → "
        "Effect,"
    ...
    few_shot_examples = [
        {
            ...
            "answer": "When you move your ankle, you stretch the joint capsule, which contains lubricating fluid. "
                      "This change in pressure can cause gas bubbles to form or be released, and when these bubbles "
                      "collapse, a popping sound may occur.",
            "evaluation": (
                ...
                "Step 2: A causal chain can be constructed: Move ankle → Stretch joint capsule → Drop in joint "
                "pressure → Gas bubbles form or are released → Bubbles collapse → Popping sound of ankle.\n"
                "Step 3: Each step in the chain represents a direct causal influence. The ankle movement causes the "
                "capsule to stretch,"
        ...
        },
        {
            ...
            "evaluation": (
                ...
                "Step 3: This is a factual question about a release date. It contains no explanation of why the event "
                "occurred or what it caused."
        ...
        },
        {
            ...
            "answer": "Estrogens and oral contraceptives are both associated with several liver-related complications "
                      "including intrahepatic cholestasis,"
                      "sinusoidal dilatation, peliosis hepatis, hepatic adenomas, hepatocellular carcinoma, "
            ...
            "evaluation": (
                ...
                "which clearly asks whether A causes B. Since this matches the predefined causal question format, "
...
def answer_filter(question: str, answer: str) -> str:
    """
    Constructs a prompt that evaluates whether the answer of a given question-answer pair is appropriate in content
    and form.
    Args:
        question (str): The question to be analyzed.
        answer (str): The answer to the question.
    ...
    instruction = (
        "Task:\n"
        "Evaluate the following question–answer pair to determine whether the answer is appropriate in content and "
        "form.\n\n"
        "Instructions:\n"
        ...
        "\t4.\tFormatting: Is the answer cleanly presented, free from formatting like brackets, hyperlinks, "
        "or edit notes?\n"
    ...
    few_shot_examples = [
        {
            ...
            "answer": "[‘diarrhea.’, ‘stomach pain.’, ‘muscle cramps.’, ‘leg or back pain.’, ‘dizziness.’, "
                      "‘headache.’, ‘sleep problems (insomnia)’, ‘tiredness, and.’]",
        ...
        {
            "question": "How is it that grown men have started enjoying My Little Pony so much, and why is this not "
                        "creeping more people out?",
            "answer": (
                "It started on 4chan as a troll, but then a lot of people noticed that it does not actually suck. "
                "This is due to Lauren Faust designed the series from the ground up to be entertaining to not just "
                "the 3-7 demographic, but that the parents would not hate.\n\n"
                "THe story lines while cliche and predictable, are entertaining. The VA talent, would be the best and "
                "most talented if only they had one or two more names."
                "The characters are far more tha the stereotypes they initially present as, characters actually "
                "develop and change, mostly.\n\n"
                "The episodes range from both Slice of Life, to disney esque stories, to traditional adventure. Not "
                "to mention the lessons presented, help remind folks of how we should act."
                "References to other amazing works see the episodes Read it and weep, Canterlot wedding, and Bridle "
                "gossip.\n\n"
                "EDIT: I'm more than open to talking more on this if ya want to. I would especially look into seeing "
                "one of the better episodes, the season 2 opener would be my choice if you really want to see why the "
                "show is great."
            ),
        ...
        },
        {
            ...
            "answer": (
                "a pinched nerve in your neck can cause pain that radiates toward your shoulder. this is also known "
                "as cervical radiculopathy."
                "cervical radiculopathy most often comes from changes in your spine due to aging or injury. bone "
                "spurs can cause a pinching of the nerves that run through the hollow space in the vertebrae."
            ),
...
def question_filter(question: str) -> str:
    ...
    instruction = (
        "Task:\n"
        "Evaluate the following question to determine whether it is clearly phrased and free of contextual "
        "ambiguity.\n\n"
        "Instructions:\n"
        ...
        "\t2.\tContext Independence: Can the question be understood and answered without relying on external context "
        "(e.g., who “he” refers to or which event is meant)?\n"
    ...
    few_shot_examples = [
        ...
        {
            "question": "What are impurities in alcohol and why do they matter? Is drinking alcohol with more "
                        "impurities less safe? Or does it just taste worse?",
